    ...
    return (
      <div className="inline-block ">
        {arr_row.map((component) => (
          <div className="inline-block opacity-10 hover:opacity-90 transition-all px-5 shadow-sm hover:shadow-lg rounded-sm hover:rounded-br-3xl hover:rounded-tl-3xl duration-1000">
            {component}
          </div>
        ))}
      </div>
...
export default function Slider(props: SliderProps) {
  return (
    <div className="mt-1 mb-1">
      ...
      <div className="mt-2 mb-1 inline-block whitespace-nowrap overflow-hidden animate-slide-80 ">
