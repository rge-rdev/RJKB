...
export default function HomepageHeader() {
  ...
  return (
    ...
    >
      <div
        className="flex aspect-auto flex-col items-center"
        style={{ height: "415px", width: "100%" }}
      >
        <h1 className="h-8 max-w-screen-sm rounded-br-full bg-gradient-to-r from-[#68fff0] to-[#d7ebe9] bg-clip-text pl-4 pr-8 text-3xl text-transparent shadow-lg dark:from-[#aae4ff] dark:to-[#44ffc1] sm:h-10 sm:pr-10 sm:text-4xl md:h-12 md:pr-12 md:text-5xl lg:h-[60px] lg:pr-14 lg:text-6xl xl:h-[72px] xl:max-w-3xl xl:pr-16 xl:text-7xl">
          FullStack Wiki
        </h1>
        <h2
          className={`mb-10 flex w-fit flex-col items-center justify-center rounded-br-full py-2 pl-10 pr-12 text-xl font-light italic text-cyan-200 shadow-lg dark:text-cyan-300 sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl`}
          style={{
            animation: "fadein 3s",
          }}
        >
