...
<Video
  ...
  poster="/vid/RJKB_hover_preview_ipad_300.jpg"
  h={300}
  title="RJKB Hover Preview Links viewed on Ipad 810x1080 resolution"
/>
<Video
  src="/vid/RJKB_hover_preview_iphone_500.mp4"
...
- ✅ set up front-end API key scoped to only perform search for documents on main typesense collection
