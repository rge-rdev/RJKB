...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><Link to="/wiki/React/React-API/Hooks-API/Stateful-Hook/useReducer"><code>useReducer()</code></Link><span>&#x20;updates&#x20;</span><Link to="/wiki/React/React-Definition/Component-Based-Architecture/Component/state"><span>state</span></Link><span>&#x20;&#x26;&#x20;trigger&#x20;re-render&#x20;by&#x20;dispatch&#x20;action&#x20;to&#x20;</span><Link to="/wiki/React/React-Stack/redux/Redux-Pattern/Reducer"><span>Reducer</span></Link><span>&#x20;</span></cite></li><li><cite className="react-tooltip__ref-list"><span>!snippet&#x20;</span><Link to="/wiki/React/React-Stack/redux/Redux-Pattern/Reducer"><span>Reducer</span></Link><span>&#x20;</span></cite></li><li><cite className="react-tooltip__ref-list"><span>!snippet&#x20;</span><Link to="/wiki/React/React-Stack/redux/Redux-Pattern/Reducer"><span>Reducer</span></Link><span>&#x20;for&#x20;counter</span><CodeBlock language="tsx">{`function reducer (state, action) {\n  if (action === "++") return state + 1\n  if (action === "--") return state - 1\n  if (action === "add") return state + action.payload\n  return state // default\n}`}</CodeBlock><CodeBlock language="tsx">{`let count = 0\ncount = reducer(count, "++")`}</CodeBlock></cite></li><li><cite className="react-tooltip__ref-list"><span>!snippet&#x20;export&#x20;default&#x20;</span><Link to="/wiki/React/React-Stack/redux/Redux-Pattern/Reducer"><span>Reducer</span></Link><span>&#x20;for&#x20;</span><Link to="/wiki/React/React-API/Hooks-API/Stateful-Hook/useReducer"><code>useReducer()</code></Link><span>&#x20;in&#x20;separate&#x20;reducer.js</span><CodeBlock language="tsx">{`export default function reducer (state, action) {\n  switch (action.type) {\n    case "MY_ACTION_1":\n      return {...state, _someValue: action.payload} // overwrite\n    case "MY_ACTION_2":\n      return {...state, _someBoolean: !state.isTrue} // flip bool\n    default:\n      return state\n  }\n}`}</CodeBlock></cite></li><li><cite className="react-tooltip__ref-list"><span>Initialization&#x20;Function</span><span>&nbsp;↔&nbsp;</span><Link to="/wiki/JS/JS-Language/Object/Function/function"><span>function</span></Link><span>&#x20;pass&#x20;as&#x20;</span><Link to="/wiki/React/React-API/Hooks-API/Stateful-Hook/useReducer/Initialization-Argument"><code>Init Arg</code></Link><span>&#x20;to&#x20;</span><Link to="/wiki/React/React-API/Hooks-API/Stateful-Hook/useReducer"><code>useReducer()</code></Link><span>&#x20;to&#x20;generate&#x20;</span><Link to="/wiki/React/React-Stack/redux/Redux-Pattern/Initial-State"><span>Initial&#x20;State</span></Link><span>&#x20;for&#x20;</span><Link to="/wiki/React/React-Stack/redux/Redux-Pattern/Reducer"><span>Reducer</span></Link><span>&#x20;</span></cite></li></ol>
