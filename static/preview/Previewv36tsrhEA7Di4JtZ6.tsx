...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><span>!snippet&#x20;</span><Link to="/wiki/JS/JS-Language/JS-Syntax/Chain/Optional-Chaining"><span>Optional&#x20;Chaining</span></Link><span></span><CodeBlock language="tsx">{`obj?.prop\nobj?.[__expr__]\nfunc?.(__arg__, __arg2__)`}</CodeBlock></cite></li><li><cite className="react-tooltip__ref-list"><span>!snippet&#x20;</span><Link to="/wiki/JS/JS-Language/JS-Syntax/Chain/Optional-Chaining"><span>Optional&#x20;Chaining</span></Link><span>&#x20;with&#x20;</span><Link to="/wiki/JS/JS-Language/JS-Syntax/JS-Operator/"><code>??</code></Link><span></span><CodeBlock language="tsx">{`const street = persons.map(\n  p => p.address?.street?.name ?? "can't find name"\n);`}</CodeBlock></cite></li><li><cite className="react-tooltip__ref-list"><span>!snippet&#x20;</span><Link to="/wiki/JS/JS-Language/JS-Syntax/Chain/Optional-Chaining"><span>Optional&#x20;Chaining</span></Link><span>&#x20;equivalent&#x20;to&#x20;</span><Link to="/wiki/JS/JS-Language/Object/RegExp/RegExp-Syntax/body-of-RegExp-expression-abc-inside-abc/Quantifier/"><code>?</code></Link><code>&#x20;_expr&#x20;:&#x20;undefined&#x20;</code><span>&#x20;</span><CodeBlock language="tsx">{`o?.prop // same as...\n(o !== undefined && o !== null) ? o.prop : undefined`}</CodeBlock></cite></li></ol>
