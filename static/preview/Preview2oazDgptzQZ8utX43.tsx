...
applies&#x20;</span><Link to="/wiki/React/React-Stack/immer"><code>immer</code></Link><span>&#x20;so&#x20;now&#x20;can&#x20;mutate&#x20;state&#x20;directly!</span><CodeBlock language="tsx">{`import { createSlice } from "@reduxjs/toolkit"\nimport type { PayloadAction } from "@reduxjs/toolkit"\nimport { RootState } from "../store"\n\ninterface CounterState {\n  value: number\n}\n\nconst initialState: CounterState = {\n  value: 0,\n}\n\nexport const counterSlice = createSlice({\n  name: "counter",\n  // \`createSlice\` will infer the state type from the \`initialState\` argument\n  initialState,\n  reducers: {\n    increment: (state) => {\n      state.value += 1\n    },\n    decrement: (state) => {\n      state.value -= 1\n    },\n    // Use the PayloadAction type to declare the contents of \`action.payload\`\n    incrementByAmount: (state, action: PayloadAction<number>) => {\n      state.value += action.payload\n    },\n  },\n})\n\nexport const { increment, decrement, incrementByAmount } = counterSlice.actions\n\n// Other code such as selectors can use the imported \`RootState\` type\nexport const selectCount = (state: RootState) => state.counter.value\n\nexport default counterSlice.reducer`}</CodeBlock></cite></li></ol>
