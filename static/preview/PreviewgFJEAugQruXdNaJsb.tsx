...
export default function PreviewgFJEAugQruXdNaJsb(){
  return (<Tooltip
  id="preview__gFJEAugQruXdNaJsb"
  place="top"
  clickable
>
  <small>
    <dfn>
      <dt><code className="react-tooltip__dt"><span>Wildcard&#x20;Character</span></code></dt>
      <dd>
        <blockquote className="react-tooltip__dd"><span><span>algebraic&#x20;placeholder&#x20;char</span></span></blockquote>
      </dd>
    </dfn>
