...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><span>contrast&#x20;</span><Link to="/wiki/JS/JS-Language/Object/Factory-Function"><span>Factory&#x20;Function</span></Link><span>&#x20;applies&#x20;</span><Link to="/wiki/JS/JS-Definition/Multi-paradigm/Paradigm/OOP/Classical-OOP-Concepts/Class/Instantiation"><span>Instantiation</span></Link><span>&#x20;w/o&#x20;using&#x20;</span><Link to="/wiki/JS/JS-Language/JS-Syntax/JS-Operator/new"><code>new</code></Link><span></span><CodeBlock language="tsx">{`function Person(name, age){\n  return {\n    name: name,\n    age: age\n  }\n}`}</CodeBlock><span>&#x20;call&#x20;constructor&#x20;w/o&#x20;new&#x20;keyword</span><CodeBlock language="tsx">{`const bob = Person(name, 18)`}</CodeBlock><span>&#x20;</span></cite></li></ol>
