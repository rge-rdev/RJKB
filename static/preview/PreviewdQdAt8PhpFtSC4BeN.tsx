...
export default function PreviewdQdAt8PhpFtSC4BeN(){
  return (<Tooltip
  id="preview__dQdAt8PhpFtSC4BeN"
  place="top"
  clickable
>
  <small>
    <dfn>
      <dt><code className="react-tooltip__dt"><code>:::danger</code></code></dt>
      <dd>
        <blockquote className="react-tooltip__dd"><span><span>danger&#x20;callout</span></span></blockquote>
      </dd>
    </dfn>
