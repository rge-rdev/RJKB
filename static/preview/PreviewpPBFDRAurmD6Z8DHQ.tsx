...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><span>combine&#x20;</span><Link to="/wiki/JS/JS-Language/Object/Date/Datenow"><code>Date.now()</code></Link><span>&#x20;with&#x20;</span><Link to="/wiki/JS/JS-Language/Object/Math/Math-Static-Method/Mathrandom"><code>Math.random()</code></Link><span>&#x20;</span></cite></li></ol>
