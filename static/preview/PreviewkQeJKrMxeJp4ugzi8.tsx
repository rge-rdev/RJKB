...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><span>to&#x20;calc&#x20;</span><Link to="/wiki/Computer-Science/Computer-Language/Computer/OS/Windows/WinSxS"><code>WinSxS</code></Link><span>&#x20;actual&#x20;size</span><CodeBlock language="bash">{`DISM.exe /Online /Cleanup-Image /AnalyzeComponentStore`}</CodeBlock></cite></li><li><cite className="react-tooltip__ref-list"><span>to&#x20;clean&#x20;</span><span ><code>WinSxS</code></span><span>&#x20;unnecessary&#x20;file&#x20;SAFE</span><CodeBlock language="bash">{`DISM.exe /Online /Cleanup-Image /StartComponentCleanup`}</CodeBlock></cite></li><li><cite className="react-tooltip__ref-list"><span>to&#x20;del&#x20;</span><span ><code>WinSxS</code></span><span>&#x20;old&#x20;ver&#x20;backups&#x20;KILL&#x20;ROLLBACK</span><CodeBlock language="bash">{`DISM.exe /Online /Cleanup-Image /StartComponentCleanup /ResetBase`}</CodeBlock><span>&#x20;</span></cite></li></ol>
