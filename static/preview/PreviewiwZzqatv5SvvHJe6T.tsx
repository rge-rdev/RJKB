...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><span>add&#x20;</span><Link to="/wiki/React/React-Stack/storybook/Story/Story-Parameter"><span>Story&#x20;Parameter</span></Link><span>&#x20;to&#x20;mock&#x20;remote&#x20;API&#x20;call</span><CodeBlock language="jsx">{`import { rest } from "msw"\nimport { MockedState } from "./TaskList.stories"\n\nexport const Default = Template.bind({})\nDefault.parameters = {\n  msw: {\n    handlers: [\n      rest.get(\n        "https://jsonplaceholder.typicode.com/todos?userId=1',\n        (req, res, ctx) => res(ctx.json(MockedState.tasks))\n      )\n    ]\n  }\n}`}</CodeBlock></cite></li></ol>
