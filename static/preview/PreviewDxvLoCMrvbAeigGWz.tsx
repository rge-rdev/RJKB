...
>
  <small>
    ...
    <ol className="font-semibold"><li><cite className="react-tooltip__ref-list"><span>use&#x20;</span><Link to="/wiki/Dev-tool/degit"><code>degit</code></Link><span>&#x20;instead&#x20;of&#x20;</span><Link to="/wiki/Dev-tool/git/git-command/clone/git-clone-URL-newName"><code>git&#x20;clone&#x20;_URL&#x20;newName</code></Link><span>&#x20;via&#x20;</span><Link to="/wiki/Dev-tool/degit/npx-degit-GITURL"><code>npx&#x20;degit&#x20;_GIT_URL</code></Link><span>&#x20;</span></cite></li><li><cite className="react-tooltip__ref-list"><span>must&#x20;</span><Link to="/wiki/Dev-tool/degit"><code>degit</code></Link><span>&#x20;execute&#x20;from&#x20;EMPTY&#x20;FOLDER&#x20;else&#x20;complain&#x20;||&#x20;must&#x20;</span><code>--force</code><span>&#x20;to&#x20;override?</span></cite></li><li><cite className="react-tooltip__ref-list"><span>clone&#x20;template&#x20;using&#x20;</span><Link to="/wiki/Dev-tool/degit"><code>degit</code></Link><span>&#x20;to</span><CodeBlock language="bash">{`npx degit chromaui/intro-storybook-react-template taskbox`}</CodeBlock></cite></li></ol>
