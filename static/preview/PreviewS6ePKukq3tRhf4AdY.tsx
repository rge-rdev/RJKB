...
export default function PreviewS6ePKukq3tRhf4AdY(){
  return (<Tooltip
  id="preview__S6ePKukq3tRhf4AdY"
  place="top"
  clickable
>
  <small>
    <dfn>
      <dt><code className="react-tooltip__dt"><code>replace</code></code></dt>
      <dd>
        <blockquote className="react-tooltip__dd"><span><span>to&#x20;replace&#x20;current&#x20;entry&#x20;in&#x20;</span><Link to="/wiki/React/React-Stack/react-router-dom/React-Router-API/react-router-v5/RR-concepts/History-Locations/History-Stack"><span>History&#x20;Stack</span></Link><span>&#x20;</span></span></blockquote>
      </dd>
    </dfn>
