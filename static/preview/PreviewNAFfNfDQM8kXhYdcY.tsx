...
export default function PreviewNAFfNfDQM8kXhYdcY(){
  return (<Tooltip
  id="preview__NAFfNfDQM8kXhYdcY"
  place="top"
  clickable
>
  <small>
    <dfn>
      <dt><code className="react-tooltip__dt"><span>Object&#x20;Literal&#x20;Type</span></code></dt>
      <dd>
