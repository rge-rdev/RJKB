...
>
  <small>
    <dfn>
      ...
      <dd>
        <blockquote className="react-tooltip__dd"><span><Link to="js-operator"><span>JS&#x20;Operator</span></Link><span>&#x20;to&#x20;return&#x20;comma&#x20;separated&#x20;list&#x20;from&#x20;</span><Link to="iterable"><span>iterable</span></Link><span>&#x20;</span></span></blockquote>
      </dd>
    </dfn>
    ...
    <Link to="spread-operator#references"><button className="react-tooltip__ref-link">
          View 6 more
        </button></Link>
    </small></Tooltip>)
}