...
export default function PreviewXwq23FmXHZhw6oPm4(){
  return (<Tooltip
  id="preview__Xwq23FmXHZhw6oPm4"
  place="top"
  clickable
>
  <small>
    <dfn>
      <dt><code className="react-tooltip__dt"><code>:::tip</code></code></dt>
      <dd>
        <blockquote className="react-tooltip__dd"><span><span>tip&#x20;</span><Link to="/wiki/React/React-Stack/docusaurus/Admonitions-Callout-Blocks"><code>Callout</code></Link><span>&#x20;</span></span></blockquote>
      </dd>
    </dfn>
