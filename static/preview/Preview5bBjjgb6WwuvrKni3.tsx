...
export default function Preview5bBjjgb6WwuvrKni3(){
  return (<Tooltip
  id="preview__5bBjjgb6WwuvrKni3"
  place="top"
  clickable
>
  <small>
    <dfn>
      <dt><code className="react-tooltip__dt"><span>ALAC</span></code></dt>
      <dd>
        <blockquote className="react-tooltip__dd"><span><span>Apple&#x20;Lossless&#x20;Audio&#x20;Codec</span></span></blockquote>
      </dd>
    </dfn>
